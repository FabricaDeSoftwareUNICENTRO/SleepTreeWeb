<%-- 
    Document   : exportar
    Created on : 15/08/2015, 23:56:28
    Author     : joao
--%>
    ...
    <div id="wrapper">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li><a href="#">
                                <i class="fa fa-user fa-fw"></i> Dados do Usuário</a>
                        </li>
                        <li class="divider"></li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Exportar Tabela</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                        ...
                        <div class="col-lg-9">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form  name="exportar" method="post" action="#">
                                        <fieldset>
                                            <div class="row">
                                                <!--PRIMEIRA COLUNA-->
                                                <div class="col-lg-3">
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <input class="btn btn-xl btn-success btn-block" type="submit" name="setTemp" value="Exportar" />
                                                    </div>
                                                    <!--FINAL SEGUNDA LINHA-->
                                                    </div>
