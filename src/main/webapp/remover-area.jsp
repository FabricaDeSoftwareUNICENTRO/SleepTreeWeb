<%-- 
    Document   : remover-area
    Created on : 15/08/2015, 23:48:50
    Author     : joao
--%>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Remover Área</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                                    ...
                                    <form  name="importar" method="post" action="#">
                                        <fieldset>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <input class="btn btn-xl btn-success btn-block" type="submit" name="setTemp" value="Remover" />
                                                    </div>
                                                    <!--FINAL SEGUNDA LINHA-->
                                                    </div>
